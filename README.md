# R3verse Sh3ll
 ...
 script avançado em Python projetado para realizar diversas tarefas de monitoramento e testes de penetração. Ele integra múltiplas funcionalidades, incluindo captura de tela, keylogging, monitoramento de processos e envio de notificações para um webhook no Discord.⠀⠀⠀⠀⠀⠀⠀⠀
